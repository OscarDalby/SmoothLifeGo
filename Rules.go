...
func (br BasicRules) S(cm CellMath, n float64, m float64) float64 {
	...
	aliveness := cm.LogisticThreshold(m, 0.5, br.M)
	...
	threshold1 := cm.Lerp(br.B1, br.D1, aliveness)
	threshold2 := cm.Lerp(br.B2, br.D2, aliveness)
	...
	newAliveness := cm.LogisticInterval(n, threshold1, threshold2, br.N)
